      ...
      <b-col sm="12" lg="12">
        <div class="iq-card">
          <form-wizard
            ...
            @on-complete="guardarCiudadano(_self)"
          >
                ...
                <b-form autocomplete="off" @submit.prevent="handleSubmit(() => registrarForm(_self))">
                  <ValidationProvider name="tipo_documento" v-slot="{ errors }">
                    <b-form-group label="TIPO DE DOCUMENTO">
                      <v-select placeholder="Seleccione ..." @search="consultarListas('tipos_documentos', $event)" :options="options.tipos_documentos" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.tipo_documento">
                  ...
                  <ValidationProvider name="genero" v-slot="{ errors }">
                    <b-form-group label="GÉNERO">
                      <v-select placeholder="Seleccione ..." @search="consultarListas('generos', $event)" :options="options.generos" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.genero">
                        <template slot="no-options">
                          <span>Escriba para buscar ...</span>
                        </template>
                      </v-select>
                  ...
                  <ValidationProvider name="estado_civil" v-slot="{ errors }">
                    <b-form-group label="ESTADO CIVIL">
                      <v-select placeholder="Seleccione ..." @search="consultarListas('estados_civiles', $event)" :options="options.estados_civiles" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.estado_civil">
                        <template slot="no-options">
                          <span>Escriba para buscar ...</span>
                        </template>
                      </v-select>
                  ...
                  <ValidationProvider name="barrrio" v-slot="{ errors }">
                    <b-form-group label="BARRIO DE RESIDENCIA">
                      <v-select placeholder="Seleccione ..." @search="consultarListas('barrios', $event)" :options="options.barrios" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.barrio">
                        <template slot="no-options">
                          <span>Escriba para buscar ...</span>
                        </template>
                      </v-select>
            ...
            <!-- <tab-content title="Información Adicional" icon="fa fa-info">
              ...
              <ValidationProvider name="ciudad_origen" v-slot="{ errors }">
                <b-form-group label="CIUDAD DE ORIGEN">
                  <v-select placeholder="Seleccione ..." @search="consultarListas('ciudades_origen', $event)" :options="options.ciudades_origen" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.ciudad_origen">
                    <template slot="no-options">
                      <span>Escriba para buscar ...</span>
                    </template>
                  </v-select>
              ...
              <ValidationProvider name="pais_origen" v-slot="{ errors }">
                <b-form-group label="PAIS DE ORIGEN">
                  <v-select placeholder="Seleccione ..." @search="consultarListas('paises_origen', $event)" :options="options.paises_origen" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.pais_origen">
                    <template slot="no-options">
                      <span>Escriba para buscar ...</span>
                    </template>
                  </v-select>
              ...
              <ValidationProvider name="respuesta_intencion" v-slot="{ errors }">
                <b-form-group label="FECHA DE LLEGADA AL PAIS">
                  <b-form-input type="date" placeholder="INGRESE FECHA DE LLEGADA AL PAIS" v-model="form.respuesta_intencion" />
                  <div class="text-danger" v-if="errors[0]">
              ...
              <ValidationProvider name="discapacidad" v-slot="{ errors }">
                <b-form-group label="TIENE ALGUNA DISCAPACIDAD">
                  <v-select placeholder="Seleccione ..." @search="consultarListas('respuestas', $event)" :options="options.respuestas" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.discapacidad">
                    <template slot="no-options">
                      <span>Escriba para buscar ...</span>
                    </template>
                  </v-select>
              ...
              <ValidationProvider name="salud" v-slot="{ errors }">
                <b-form-group label="TIENE SISTEMA DE SALUD">
                  <v-select placeholder="Seleccione ..." @search="consultarListas('respuestas', $event)" :options="options.respuestas" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.salud">
                    <template slot="no-options">
                      <span>Escriba para buscar ...</span>
                    </template>
                  </v-select>
              ...
              <ValidationProvider name="estudia_actualmente" v-slot="{ errors }">
                <b-form-group label="SE ENCUENTRA ESTUDIANDO ACTUALMENTE">
                  <v-select placeholder="Seleccione ..." @search="consultarListas('respuestas', $event)" :options="options.respuestas" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.estudia_actualmente">
                    <template slot="no-options">
                      <span>Escriba para buscar ...</span>
                    </template>
                  </v-select>
              ...
              <ValidationProvider name="nivel_escolaridad" v-slot="{ errors }">
                <b-form-group label="NIVEL DE ESCOLARIDAD">
                  <v-select placeholder="Seleccione ..." @search="consultarListas('niveles_escolares', $event)" :options="options.niveles_escolares" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.nivel_escolar">
                    <template slot="no-options">
                      <span>Escriba para buscar ...</span>
                    </template>
                  </v-select>
              ...
              <ValidationProvider name="trabajo" v-slot="{ errors }">
                <b-form-group label="ACTUALMENTE SE ENCUENTRA LABORANDO">
                  <v-select placeholder="Seleccione ..." @search="consultarListas('respuestas', $event)" :options="options.respuestas" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.trabajo">
                    <template slot="no-options">
                      <span>Escriba para buscar ...</span>
                    </template>
                  </v-select>
              ...
              <ValidationProvider name="tipo_empleo" v-slot="{ errors }">
                <b-form-group label="TIPO DE EMPLEO">
                  <v-select placeholder="Seleccione ..." @search="consultarListas('tipos_empleos', $event)" :options="options.tipos_empleos" label="valor_campo_1" :reduce="option => option.codigo_campo" v-model="form.tipo_empleo">
                    <template slot="no-options">
                      <span>Escriba para buscar ...</span>
                    </template>
                  </v-select>
