...
import am4geodataWorldLow from "~/node_modules/@amcharts/amcharts4-geodata/worldLow";
// eslint-disable-next-line camelcase
import am4themes_dark from "~/node_modules/@amcharts/amcharts4/themes/amchartsdark";
        ...
        map() {
            ...
            (i.tooltipText = "{name}"),
                ...
                o.events.on("hit", function(e) {
                    ...
                    // eslint-disable-next-line no-sequences,no-unused-expressions
                    t &&
                        ((e.target.isHover = !1), (r.geodataSource.url = "https://www.amcharts.com/lib/4/geodata/json/" + t + ".json"), r.geodataSource.load());
                });
            const c = [];
            for (const s in e) {
