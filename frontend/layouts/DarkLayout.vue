                ...
                <template v-slot:body>
                    <b-row>
                        <b-col cols="12" class="justify-content-between">
                            ...
                            <div class="text-center">
                                <div v-for="(item, index) in colors" :key="index" class="d-inline-flex justify-content-between">
                                    <div :style="`background: ${item.primary};border-radius: 4px;`" @click="changeColor(item)" class="p-3 mx-1"></div>
                                </div>
                            </div>
                        </b-col>
                        ...
                        <b-col cols="12" class="justify-content-between">
                            ...
                            <div class="text-center d-flex">
                                <b-form-radio-group id="radio-group-1" v-model="animated" :options="animateClass" name="radio-options"></b-form-radio-group>
                            </div>
                        </b-col>
                    </b-row>
                </template>
                    ...
                    <ul class="navbar-nav ml-auto navbar-list">
                        <li class="nav-item">
                            <a class="search-toggle iq-waves-effect language-title" href="javascript:void(0)"
                                ><img :src="selectedLang.image.default" alt="img-flaf" class="img-fluid mr-1" style="height: 16px; width: 16px;"/>
                            ...
                            <div class="iq-sub-dropdown">
                                <a class="iq-sub-card" href="javascript:void(0)" v-for="(lang, i) in langsOptions" :key="`Lang${i}`" @click="langChange(lang)">
                                    <img :src="lang.image.default" alt="img-flaf" class="img-fluid mr-2" />{{ lang.title }}
                                </a>
                            </div>
                        </li>
                        <li class="nav-item">
...
export default {
    name: "DarkLayout1",
    components: {
        Loader: () => import("~/components/Vito/Loader"),
        RightSideBar: () => import("~/components/Vito/Sidebars/RightSideBar"),
        SideBarStyle1: () => import("~/components/Vito/Sidebars/SideBarStyle1"),
        NavBarStyle1: () => import("~/components/Vito/NavBars/NavBarStyle1"),
        BreadCrumb: () => import("~/components/Vito/BreadCrumb"),
        FooterStyle1: () => import("~/components/Vito/Footers/FooterStyle1"),
        AmChart: () => import("~/components/Vito/Charts/AmChart"),
        Lottie: () => import("~/components/Vito/Lottie"),
        "iq-card": () => import("~/components/Vito/Cards/iq-card")
    },
    head() {
        return {
            bodyAttrs: {
