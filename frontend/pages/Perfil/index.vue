                            ...
                            <b-row>
                                ...
                                <b-col cols="12">
                                    <tab-nav :pills="true" id="pills-tab" class="profile-feed-items d-flex justify-content-end">
                                        <tab-nav-items :active="true" id="pills-feed-tab" href="#informacion-personal" role="tab" :ariaSelected="true" title="Información Personal" />
                                        <tab-nav-items :active="false" id="pills-activity-tab" href="#otra-informacion" role="tab" :ariaSelected="false" title="Otra Información" />
                                        <tab-nav-items :active="false" id="pills-activity-tab" href="#nivel-riesgo" role="tab" :ariaSelected="false" title="Nivel de Riesgo" />
                                        <tab-nav-items :active="false" id="pills-activity-tab" href="#maps" role="tab" :ariaSelected="false" title="Georeferenciacion" />
                                        <tab-nav-items :active="false" id="pills-activity-tab" href="#docs" role="tab" :ariaSelected="false" title="Docs" />
                                    </tab-nav>
                                </b-col>
                            </b-row>
                            <b-row>
                    ...
                    <iq-card>
                        ...
                        <template v-slot:body>
                            <div>
                                <b-row>
                                    <b-col cols="4">
                                        <vue-speedometer :minValue="0" :maxValue="100" :customSegmentStops="[0, 33,66, 100]" :segmentColors="['#ffdf7e', '#b8daff','#ed969e']" :value="40" />
...
export default {
    ...
    data: () => ({
        ...
        items: [{
                nivel: "BAJO",
                definicion: "Actualmente no se ha identificado ningún factor relevante de vulnerabilidad. El riesgo de daños de la persona parece bajo y manejable por medio de los factores de resiliencia actuales.",
                _rowVariant: "warning",
            },
            {
                nivel: "MEDIO",
                definicion: "Se podría desarrollar una vulnerabilidad importante si no se adoptan medidas de apoyo preventivas. Se recomienda una supervisión frecuente de la condición de vulnerabilidad.",
                _rowVariant: "primary",
            },
            {
                nivel: "ALTO",
                definicion: "Resulta evidente una vulnerabilidad importante. Se recomienda una evaluación de seguimiento y el desarrollo de un plan de atención. Se debe hacer referencia a la descripción que el entrevistador hace del riesgo de daños identificado y de la necesidad inmediata de apoyo",
                _rowVariant: "danger",
            },
        ],
    ...
    methods: {
        consultaCiudadano() {
            ...
            this.modulo_id = this.ciudadano[0].id;
    ...
    created() {
        console.log(
            "estoy creando" + this.$store.state.Familias.ciudadano[0].fecha_llegada
        );
        this.modulo_id = this.$store.state.Familias.ciudadano[0].id;
    },
    mounted() {
