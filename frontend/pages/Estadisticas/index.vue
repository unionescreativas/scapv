          ...
          <template v-slot:body>
            <ul class="suggestions-lists m-0 p-0">
              <li v-for="(invoice, index) in monthlyInvocie" :key="index" class="d-flex mb-4 align-items-center">
                <div :class="'profile-icon iq-bg-' + invoice.color">
                  <span><i class="ri-check-fill"></i></span>
                </div>
                <div class="media-support-info ml-3">
                  <h6>{{ invoice.title }}</h6>
                  <p class="mb-0">
                    <span :class="'text-' + invoice.color">{{ invoice.paid_month }} paid</span> month out of
                    {{ invoice.total_month }}
                  </p>
                </div>
                <div class="media-support-amount ml-3">
                  <h6>
                    <span :class="'text-' + invoice.color">$</span><b> {{ invoice.amount }}</b>
                  </h6>
          ...
          <template v-slot:body>
            <ul class="suggestions-lists m-0 p-0">
              <li v-for="(payment, index) in paymentHistory" :key="index" class="d-flex mb-4 align-items-center">
                <div :class="'profile-icon bg-' + payment.color">
                  <span><i :class="payment.icon"></i></span>
                </div>
                <div class="media-support-info ml-3">
                  <h6>{{ payment.title }}</h6>
