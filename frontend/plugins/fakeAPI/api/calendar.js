...
export const Events = [
    ...
    new Event(
        {
            ...
            body: "",
            isAllday: true,
            start: moment(new Date(), "YYYY-MM-DD").add(-1, "days").format("YYYY-MM-DD") + "T19:00:00.000Z",
    ...
    new Event(
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-2, "days").format("YYYY-MM-DD") + "T12:00:00.000Z",
        ...
        },
        {
            ...
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-2, "days").format("YYYY-MM-DD") + "T11:30:00.000Z",
        ...
        },
        {
            ...
            attendees: ["Brett Underwood", "Leon Moody", "Elijah Payne", "Mayme Fleming", "Susan Waters", "Connor Barrett", "Bertie Romero"],
        }
    ),
    new Event(
        {
            ...
            body: "",
            isAllday: true,
            start: moment(new Date(), "YYYY-MM-DD").add(-3, "days").format("YYYY-MM-DD") + "T06:30:00.000Z",
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(0, "days").format("YYYY-MM-DD") + "T23:00:00.000Z",
        ...
        },
        {
            ...
            body: "",
            isAllday: true,
            start: moment(new Date(), "YYYY-MM-DD").add(0, "days").format("YYYY-MM-DD") + "T23:30:00.000Z",
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-1, "days").format("YYYY-MM-DD") + "T11:00:00.000Z",
    ...
    new Event(
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(1, "days").format("YYYY-MM-DD") + "T12:30:00.000Z",
    ...
    new Event(
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(0, "days").format("YYYY-MM-DD") + "T20:30:00.000Z",
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-3, "days").format("YYYY-MM-DD") + "T02:30:00.000Z",
    ...
    new Event({
        ...
        attendees: ["John Ramsey", "Gary Davidson", "Clayton Ruiz", "Oscar Brewer", "Glenn Jimenez", "Henry Austin"],
    }),
    new Event({
        ...
        attendees: ["Florence Stewart", "Dorothy Ingram", "Clara Stephens", "Callie Santiago", "Derrick Waters", "Jimmy Long"],
    }),
    new Event({
    ...
    new Event({
        ...
        attendees: ["Francisco Long", "Luis Gardner", "Norman Rose", "Lilly Black", "Ola Ramirez", "Garrett Henry", "Louis Curtis"],
    }),
    new Event(
        {
        ...
        },
        {
            ...
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(1, "days").format("YYYY-MM-DD") + "T00:30:00.000Z",
            ...
            attendees: ["Carl Cruz", "Jon Bennett", "Floyd Herrera", "Dora Fleming", "Nettie McGee", "Roxie Sutton", "Blanche Porter"],
        }
    ),
    new Event({
        ...
        attendees: ["Leon Freeman", "Barry Henry", "Mamie White", "Larry Maxwell", "Corey Curtis", "Elizabeth Walton"],
    }),
    new Event({
    ...
    new Event({
        ...
        attendees: ["Sophia Hale", "Alan Thompson", "Fannie Pittman", "Verna Obrien", "Pearl Sherman", "Rosalie Hart"],
    }),
    new Event({
    ...
    new Event(
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-1, "days").format("YYYY-MM-DD") + "T09:00:00.000Z",
        ...
        },
        {
            ...
            body: "",
            isAllday: true,
            start: moment(new Date(), "YYYY-MM-DD").add(1, "days").format("YYYY-MM-DD") + "T07:00:00.000Z",
            ...
            attendees: ["Billy Porter", "Hester Chapman", "Tony Freeman", "Mabel Alvarez", "Mayme Henderson", "Georgia Haynes", "Rachel Campbell"],
        }
    ),
    new Event({
        ...
        attendees: ["Maurice Welch", "Mildred Cross", "Lydia Mills", "Isabelle Simpson", "Callie Soto", "Jeffrey McDaniel", "Della Knight", "Bernice Brewer"],
    }),
    new Event({
        ...
        attendees: ["Tony McKinney", "Devin Marsh", "Luella McLaughlin", "Rosie Burns", "Raymond Rogers", "Lottie Atkins"],
    }),
    new Event(
        {
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(0, "days").format("YYYY-MM-DD") + "T16:00:00.000Z",
    ...
    new Event({
        ...
        attendees: ["Miguel Potter", "Leo Mann", "Lee Carr", "Olivia Ryan", "Micheal Beck", "Bill Dennis"],
    }),
    new Event(
        {
            ...
            body: "",
            isAllday: true,
            start: moment(new Date(), "YYYY-MM-DD").add(-1, "days").format("YYYY-MM-DD") + "T16:30:00.000Z",
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-3, "days").format("YYYY-MM-DD") + "T20:00:00.000Z",
            ...
            attendees: ["Annie Jimenez", "Christine Nash", "Lettie Marsh", "Milton Beck", "Luke Washington", "Todd Ramirez", "Mildred Hawkins"],
        }
    ),
    new Event({
    ...
    new Event(
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-3, "days").format("YYYY-MM-DD") + "T08:30:00.000Z",
    ...
    new Event(
        {
            ...
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(1, "days").format("YYYY-MM-DD") + "T11:30:00.000Z",
    ...
    new Event(
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-3, "days").format("YYYY-MM-DD") + "T08:00:00.000Z",
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(0, "days").format("YYYY-MM-DD") + "T07:00:00.000Z",
    ...
    new Event(
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-1, "days").format("YYYY-MM-DD") + "T22:00:00.000Z",
        ...
        },
        {
            ...
            attendees: ["Ophelia Sanchez", "Alma Floyd", "Zachary Gardner", "Nina Salazar", "Cynthia Hansen"],
        }
    ),
    new Event({
    ...
    new Event({
        ...
        attendees: ["David Roberson", "Ida Kim", "Garrett Larson", "Francis Vega", "Mildred Carr", "Jerry Ramos"],
    }),
    new Event({
    ...
    new Event(
        ...
        },
        {
            ...
            body: "",
            isAllday: true,
            start: moment(new Date(), "YYYY-MM-DD").add(1, "days").format("YYYY-MM-DD") + "T06:00:00.000Z",
    ...
    new Event(
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-3, "days").format("YYYY-MM-DD") + "T14:30:00.000Z",
        ...
        },
        {
            ...
            body: "",
            isAllday: true,
            start: moment(new Date(), "YYYY-MM-DD").add(-3, "days").format("YYYY-MM-DD") + "T10:00:00.000Z",
            end: moment(new Date(), "YYYY-MM-DD").add(1, "days").format("YYYY-MM-DD") + "T13:00:00.000Z",
            category: "allday",
            dueDateClass: "",
            color: "#ffffff",
        ...
        },
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-2, "days").format("YYYY-MM-DD") + "T12:30:00.000Z",
    ...
    new Event(
        {
            ...
            body: "",
            isAllday: true,
            start: moment(new Date(), "YYYY-MM-DD").add(-3, "days").format("YYYY-MM-DD") + "T22:30:00.000Z",
    ...
    new Event({
        ...
        attendees: ["Willie Aguilar", "Georgia Yates", "Eula Simmons", "Cory Swanson", "Russell Rowe", "Vincent Duncan", "Jack Shaw", "Kevin Saunders"],
    }),
    new Event({
    ...
    new Event(
        {
            ...
            body: "",
            isAllday: false,
            start: moment(new Date(), "YYYY-MM-DD").add(-1, "days").format("YYYY-MM-DD") + "T12:00:00.000Z",
            end: moment(new Date(), "YYYY-MM-DD").add(-1, "days").format("YYYY-MM-DD") + "T14:00:00.000Z",
            category: "milestone",
            dueDateClass: "",
            color: "#fd6256",
    ...
    new Event({
        ...
        attendees: ["Chris Clayton", "Johnny Barnes", "Nora Reese", "Eliza Alvarado", "Larry Graham", "Joe Morrison", "Dean Stone", "Philip Foster"],
    }),
    new Event({
