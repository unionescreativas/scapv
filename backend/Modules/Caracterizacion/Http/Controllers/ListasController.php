    ...
    public function store(ListasRequest $request) {
        ...
        foreach ($request->all() as $key => $value) {
            ...
            $data[$key] = $variableConsulta::create([
                'nombre_lista' => $request[$key]["nombre_lista"],
                'codigo_campo' => $request[$key]["codigo_campo"],
                'valor_campo_1' => $request[$key]["valor_campo_1"],
                'valor_campo_2' => $request[$key]["valor_campo_2"] ?? null,
                'valor_campo_3' => $request[$key]["valor_campo_3"] ?? null,
                'valor_campo_4' => $request[$key]["valor_campo_4"] ?? null,
            ]);
            //Campos a guardar aquí--------------->
        }
